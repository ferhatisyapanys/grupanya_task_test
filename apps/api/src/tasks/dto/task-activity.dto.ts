...
export class ActivityLogDto {
  @IsIn(['YETKILIYE_ULASILDI','YETKILIYE_ULASILAMADI','ISLETMEYE_ULASILAMADI','TEKLIF_VERILDI','KARSITEKLIF','TEKLIF_KABUL','TEKLIF_RED','ISLETME_CALISMAK_ISTEMIYOR','GRUPANYA_CALISMAK_ISTEMIYOR','TEKRAR_ARANACAK'])
  reason!: string
